...
class Critic(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(NUM_STATES + action_dim, 64)
        self.fc2 = nn.Linear(64, 128)
...
class Agent(nn.Module):
    ...
    def learn(self):
        ...
        if self.update_times%TARGET_UPDATE_PERIOD == 0:
